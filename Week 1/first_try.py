...
def swap_columns(df, column1, column2): # deze functie moet ergens anders, of mergen   
    """
...
def give_destinations(station, dataframe): 
    """
...
def determine_best_direction(station, dataframe, passed_stations, distance_travelled, max_travel_time):
    """
